...
build_test:
	...
	git submodule add --force -b release-v4.8 https://github.com/OpenZeppelin/openzeppelin-contracts lib/openzeppelin-contracts
	cd lib/openzeppelin-contracts && git checkout release-v4.8
